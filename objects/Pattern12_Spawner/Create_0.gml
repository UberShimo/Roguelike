...
instance_create_depth(x+xGrid*2, y+yGrid*1, 0, Wall1_Obj);
instance_create_depth(x+xGrid*4, y+yGrid*1, 0, Wall1_Obj);
instance_create_depth(x+xGrid*5, y+yGrid*1, 0, Wall1_Obj);
instance_create_depth(x+xGrid*6, y+yGrid*1, 0, Wall1_Obj);
instance_create_depth(x+xGrid*7, y+yGrid*1, 0, Wall1_Obj);
instance_create_depth(x+xGrid*1, y+yGrid*2, 0, Wall1_Obj);
...
instance_create_depth(x+xGrid*2, y+yGrid*3, 0, Wall1_Obj);
instance_create_depth(x+xGrid*1, y+yGrid*4, 0, Wall1_Obj);
instance_create_depth(x+xGrid*2, y+yGrid*4, 0, Wall1_Obj);
instance_create_depth(x+xGrid*6, y+yGrid*4, 0, Wall1_Obj);
instance_create_depth(x+xGrid*7, y+yGrid*4, 0, Wall1_Obj);
instance_create_depth(x+xGrid*6, y+yGrid*5, 0, Wall1_Obj);
...
instance_create_depth(x+xGrid*7, y+yGrid*6, 0, Wall1_Obj);
instance_create_depth(x+xGrid*1, y+yGrid*7, 0, Wall1_Obj);
instance_create_depth(x+xGrid*2, y+yGrid*7, 0, Wall1_Obj);
instance_create_depth(x+xGrid*3, y+yGrid*7, 0, Wall1_Obj);
instance_create_depth(x+xGrid*4, y+yGrid*7, 0, Wall1_Obj);
instance_create_depth(x+xGrid*6, y+yGrid*7, 0, Wall1_Obj);
