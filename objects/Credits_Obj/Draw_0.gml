...
if(distance_to_point(mouse_x, mouse_y) < 1){
	image = 1;
	draw_sprite_ext(Paper_Spr, 0, PaperSpawn1_Obj.x, PaperSpawn1_Obj.y-16, 1, 0.9, 0, c_white, 1);
	...
	draw_sprite_ext(SoftwaresUsed_Text, 0, PaperSpawn1_Obj.x+24, PaperSpawn1_Obj.y+148, s, s, 0, c_black, 1);
}
// Draw self
